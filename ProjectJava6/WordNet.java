...
public class WordNet {
    ...
    public String sca(String noun1, String noun2) {
        ShortestCommonAncestor a = new ShortestCommonAncestor(G);
        Iterable<Integer> subsetA = st.get(noun1);
        Iterable<Integer> subsetB = st.get(noun2);
        int ancestor = a.ancestor(subsetA, subsetB);
    ...
    public int distance(String noun1, String noun2) {
        ...
        Iterable<Integer> subsetA = st.get(noun1);
        Iterable<Integer> subsetB = st.get(noun2);
        int length = a.length(subsetA, subsetB);
        return length;
    }
